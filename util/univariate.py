...
def add_line(dj_dx, x1, y1, d, ax):
    ...
    ax.annotate(
        r"$\frac{\partial J}{\partial w}$ =%d" % dj_dx, fontsize=14,
        xy=(x1, y1),
        xycoords='data',
        xytext=(xoff, 10),
...
def plt_gradients(x_train, y_train, f_compute_gradient, f_compute_cost = compute_cost):
    #===============
    #  First subplot - Cost vs W
    #===============
...
def plt_contour_wgrad(
    ...
    """Plot value of cost function over each iteration on a contour plot -> w, b, J(w, b)"""    
...
def plt_divergence(p_hist, J_hist, x_train,y_train):
    ...
    #===============
    #  First subplot - Cost vs Weight (2D)
    #===============
